...
class AdminJobDataDialog extends StatefulWidget {
  final Function(Job) onSubmit;

  AdminJobDataDialog({required this.onSubmit});

  @override
  _JobDataDialogState createState() => _JobDataDialogState();
}

class _JobDataDialogState extends State<AdminJobDataDialog> {
 ...
 void _postJob() async {
  try {
    ...
    Job job = Job(
     ...
     _jobController.adminpostJob(job);
  } catch (e) {
